...
export const PC_COMPONENTS: ComponentCatalogItem[] = [
  ...
  },
  {
    ...
    scaffold: { renderType: "FlexBox", isRow: true, itemNum: 1, itemConfig: [{ isFixed: false, paddingSize: "base", clearPadding: [], isHidden: false, contentType: "container", defaultSlot: null }] },
    props: [
  ...
  },
  {
    ...
    group: "form",
    category: "other",
    scaffold: { renderType: "FilterItem", label: "筛选", layout: { xs: 24, sm: 12, md: 8, lg: 6, xl: 4 }, defaultSlot: null },
